  ...
  return (
    <div className="group relative flex cursor-pointer">
      <motion.img
        ...
        className="rounded-full border border-gray-500 object-cover w-24 h-24 md:w-28 md:h-28 xl:w-20 xl:h-20 filter group-hover:grayscale transition duration-300 ease-in-out"
      />
